...
h5_dir_mc = "/data/uclhc/uci/user/dantrim/ntuples/n0301/mc/h5/"
h5_dir_data = "/data/uclhc/uci/user/dantrim/ntuples/n0301/data/h5/"

#loaded_samples = []
#loaded_signals = []

#lumi_factor = 36.06
lumi_factor = 78.21 # fb-1
...
wt.linestyle = '-'
wt.color = "#e94f37"
wt.load(filelist_dir + "singletop", h5_dir_mc)
...
ztt.linestyle = '-'
ztt.color = "#44bba4" 
ztt.load(filelist_dir + "zjets_tt", h5_dir_mc)
...
zee.linestyle = '-'
zee.color = "#52796f" 
zee.load(filelist_dir + "zjets_ee", h5_dir_mc)
...
zmm.linestyle = '-'
zmm.color = "#84a98c" 
zmm.load(filelist_dir + "zjets_mm", h5_dir_mc)
...
dib.linestyle = '-'
dib.color = "#f6f7eb" 
dib.load(filelist_dir + "diboson", h5_dir_mc)
...
wjets.linestyle = '-'
wjets.color = "#726e97" 
wjets.load(filelist_dir + "wjets", h5_dir_mc)
...
dy.linestyle = '-'
dy.color = "#ff9505" 
dy.load(filelist_dir + "drellyan", h5_dir_mc)
...
data.linestyle = '-'
data.color = 'k'
data.load(filelist_dir + "n0301_data", h5_dir_data)
...
r = region.Region("zee", "Zee")
r.tcut = "nBJets==0 && mll>20 && nLeptons==2 && nElectrons==2 && l0_pt>25 && l1_pt>20" # && trig_e60_lhmedium_nod0==1"
#r.tcut = "mll>20 && nLeptons==2 && nElectrons==2 && l0_pt>65 && trig_e60_lhmedium_nod0==1" 
loaded_regions.append(r)

r = region.Region("zmm", "Zmm")
r.tcut = "nBJets==0 && mll>20 && nLeptons==2 && nMuons==2 && trig_mu22_mu8noL1==1"
loaded_regions.append(r)

r = region.Region("dfval", "DF")
r.tcut = "mll>20 && nLeptons==2 && nElectrons==1 && nMuons==1 && (trig_e17_lhloose_nod0_mu14==1 || trig_e26_lhmedium_nod0_mu8noL1==1 || trig_e7_lhmedium_nod0_mu24==1) && l0_pt>25 && l1_pt>20"
loaded_regions.append(r)

## CR ttbar
r = region.Region("crtt", "CR-$t\\bar{t}$")
r.tcut = "nBJets==2 && nLeptons==2 && mll>20 && mbb>100 && mbb<140 && mt2_llbb>100 && mt2_llbb<140 && dRll>1.5 && dRll<3.0 && HT2Ratio>0.4 && HT2Ratio<0.6" # && (trig_e17_lhloose_nod0_mu14==1 || trig_e7_lhmedium_nod0_mu24==1) && l0_pt>25 && l1_pt>20"
...
#variables["mll"] =  { "zee" : [5, 20, 200], "zmm" : [5, 20, 200], "dfval" : [5, 20, 400] }
variables["l0_pt"] = { "zee" : [5, 20, 200], "zmm" : [5, 20, 200], "dfval" : [5, 20, 200] , "crtt" : [10, 0, 220]}
variables["l1_pt"] = { "zee" : [5, 20, 120], "zmm" : [5, 20, 120], "dfval" : [5, 20, 200] , "crtt" : [10, 0, 100]}
variables["mt2_bb"] = { "crtt" : [5, 0, 100] } 
variables["met"] = { "crtt" : [10, 0, 180] } 
...
#                              "crwt" : [50, 130, 1000]   , "vrwt" : [50, 115, 800]    , "sr_test" : [20, 0, 5000]  }
...
#                              "crwt" : [20, 0, 300]      , "vrwt" : [30, 0, 300]      , "sr_test" : [10, 0, 5000]  }
...
#                              "crwt" : [40, 130, 800]    , "vrwt" : [50, 115, 640]    , "sr_test" : [10, 0, 5000]  }
...
#                              "crwt" : [10, 140, 300]    , "vrwt" : [20, 110, 310]    , "sr_test" : [10, 0, 5000]  }
