...
top_sf =  0.96 #0.97 #0.97# 1.#0.64 #0.87 #0.88#0.905#0.93 #0.91 #0.97 #0.98 #0.98
z_sf = 1.00#1.30#27#2 #1.3
...
hh.is_signal = True
hh.scalefactor = lumi_factor * 1000#* 350
hh.fillstyle = 0
hh.linestyle = '--'
hh.color = 'r'
#hh.load(filelist_dir + "wwbb_mc16a", h5_dir_mc, tags = tags)
#hh.load('/data/uclhc/uci/user/dantrim/n0306val/susynt-read/filelists_mwt2/wwbb_mc16a', h5_dir_mc, tags = tags)
...
#variables["abs(dphi_WW_bb)"]        = { "crtoptest" : [0.16, 0, 3.2],       "vrtoptest" : [0.2, 0, 3.2],       "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.32, 0, 3.2]}


# definitions as of Jan 21
variables["met"]                    = { "crtoptest" : [50, 0, 600]    ,    "vrtoptest" : [100, 0, 1000]    ,    "crztest" :  [25, 0, 500],    "vrztest" :  [25, 0, 500]}
variables["mbb"]                    = { "crtoptest" : [100, 100, 1000],       "vrtoptest" : [50, 0, 1000],       "crztest" :  [100, 0, 2000],  "vrztest" :  [60, 0, 1200]}
variables["abs(metPhi)"]            = { "crtoptest" : [0.32, 0, 3.2] ,   "vrtoptest" : [0.16, 0, 3.2] ,   "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.32, 0, 3.2]}
variables["mll"]                    = { "crtoptest" : [5, 20, 60]    ,     "vrtoptest" : [5, 20, 60]    ,     "crztest" : [5, 70, 115],     "vrztest" : [5, 70, 115]}
variables["dRll"]                   = { "crtoptest" : [0.25, 0, 2.5]      ,  "vrtoptest" : [0.15, 0, 3]      ,  "crztest" : [0.3, 0, 6],      "vrztest" : [0.15, 0, 2.4]}
variables["pTll"]                   = { "crtoptest" : [25, 0, 400]    ,    "vrtoptest" : [25, 0, 500]    ,    "crztest" :  [50, 0, 1000],   "vrztest" :  [50, 0, 800]}
variables["abs(dphi_ll)"]           = { "crtoptest" : [0.16, 0, 2.24] ,   "vrtoptest" : [0.16, 0, 3.2] ,   "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.1, 0, 2]} 
variables["abs(dphi_bb)"]           = { "crtoptest" : [0.32, 0, 3.2] ,   "vrtoptest" : [0.16, 0, 3.2] ,   "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.16, 0, 3.2]}
variables["abs(dphi_met_ll)"]       = { "crtoptest" : [0.32, 0, 3.2] ,   "vrtoptest" : [0.16, 0, 3.2] ,   "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.16, 0, 3.2]}
variables["met_pTll"]               = { "crtoptest" : [100, 0, 1000]    ,    "vrtoptest" : [40, 0, 800]    ,    "crztest" :  [30, 0, 900],    "vrztest" :  [50, 0, 1000]}
variables["nJets"]                  = { "crtoptest" : [1, 0, 20]       ,   "vrtoptest" : [1, 0, 20]       ,   "crztest" : [1, 0, 20],       "vrztest" : [1, 0, 20]}    
variables["nSJets"]                 = { "crtoptest" : [1, 0, 20]       ,   "vrtoptest" : [1, 0, 20]       ,   "crztest" : [1, 0, 20],       "vrztest" : [1, 0, 20]}   
variables["nBJets"]                 = { "crtoptest" : [1, 0, 10]       ,   "vrtoptest" : [1, 0, 10]       ,   "crztest" : [1, 0, 10],       "vrztest" : [1, 0, 10]}   
variables["HT2"]                    = { "crtoptest" : [100, 200, 1500]    ,    "vrtoptest" : [90, 0, 1800]    ,    "crztest" : [80, 0, 1600],    "vrztest" : [75, 100, 1600]}
variables["HT2Ratio"]               = { "crtoptest" : [0.1, 0.2, 1]  ,    "vrtoptest" : [0.05, 0.2, 1]  ,    "crztest" : [0.05, 0.5, 1],   "vrztest" : [0.05, 0.4, 1]}
variables["l0_pt"]                  = { "crtoptest" : [20, 20, 380]    ,    "vrtoptest" : [25, 0, 500]    ,    "crztest" :  [50, 0, 1000],   "vrztest" :  [30, 0, 600]} 
variables["l1_pt"]                  = { "crtoptest" : [10, 10, 130]     ,    "vrtoptest" : [9, 0, 180]     ,    "crztest" : [20, 0, 400],     "vrztest" : [14, 0, 280]}
variables["abs(l0_phi)"]            = { "crtoptest" : [0.32, 0, 3.2] ,   "vrtoptest" : [0.32, 0, 3.2] ,   "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.32, 0, 3.2]}
variables["abs(l1_phi)"]            = { "crtoptest" : [0.32, 0, 3.2] ,   "vrtoptest" : [0.32, 0, 3.2] ,   "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.32, 0, 3.2]}
variables["j0_pt"]                  = { "crtoptest" : [120, 0, 1200]    ,    "vrtoptest" : [60, 0, 1200]    ,    "crztest" : [60, 0, 1200],    "vrztest" : [50, 0, 1000]}
variables["j1_pt"]                  = { "crtoptest" : [60, 0, 720]     ,   "vrtoptest" : [25, 0, 500]     ,   "crztest" : [40, 0, 800],     "vrztest" : [25, 0, 550]} 
variables["abs(j0_phi)"]            = { "crtoptest" : [0.32, 0, 3.2] ,   "vrtoptest" : [0.16, 0, 3.2] ,   "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.32, 0, 3.2]}
variables["abs(j1_phi)"]            = { "crtoptest" : [0.32, 0, 3.2] ,   "vrtoptest" : [0.16, 0, 3.2] ,   "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.16, 0, 3.2]}
variables["bj0_pt"]                 = { "crtoptest" : [80, 0, 880]    ,   "vrtoptest" : [40, 0, 800]    ,   "crztest" :  [60, 0, 1200],   "vrztest" :  [60, 0, 1200]}
variables["bj1_pt"]                 = { "crtoptest" : [25, 0, 400]     ,   "vrtoptest" : [20, 0, 400]     ,   "crztest" : [40, 0, 800],     "vrztest" : [20, 0, 400]}
variables["abs(bj0_phi)"]           = { "crtoptest" : [0.32, 0, 3.2] ,   "vrtoptest" : [0.16, 0, 3.2] ,   "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.16, 0, 3.2]}
variables["abs(bj1_phi)"]           = { "crtoptest" : [0.32, 0, 3.2] ,   "vrtoptest" : [0.16, 0, 3.2] ,   "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.16, 0, 3.2]}
variables["mt2_bb"]                 = { "crtoptest" : [20, 0, 320],        "vrtoptest" : [20, 0, 400],        "crztest" : [10, 0, 200],     "vrztest" : [15, 0, 300]}
#variables["NN_d_hh"]                = { "crtoptest" : [1, -15, 15],        "vrtoptest" : [1, 5, 12],        "crztest" : [1, 2, 16],       "vrztest" : [1, 2, 12]}  
variables["NN_d_hh"]                = { "crtoptest" : [0.1, 3.5, 5.3],        "vrtoptest" : [1, 5, 12],        "crztest" : [1, 0, 16],       "vrztest" : [1, 2, 12]}  
variables["dRbb"]                   = { "crtoptest" : [0.5, 0, 6],         "vrtoptest" : [0.4, 0, 5.2],         "crztest" : [0.5, 0, 6],      "vrztest" : [0.5, 0, 6]}   
variables["abs(deta_ll)"]           = { "crtoptest" : [0.2, 0, 1.8],        "vrtoptest" : [0.1, 0, 2],        "crztest" : [0.1, 0, 2],      "vrztest" : [0.1, 0, 2]}   
variables["abs(dphi_WW_bb)"]        = { "crtoptest" : [0.32, 0, 3.2],       "vrtoptest" : [0.2, 0, 3.2],       "crztest" : [0.16, 0, 3.2],   "vrztest" : [0.32, 0, 3.2]}

#tmp = {}
##tmp["NN_d_hh"] = { "sr_test" : [2, -30, 20] }
#tmp["NN_d_hh"] = { "mllpre" : [1, -12, 15] }
