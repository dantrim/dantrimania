...
top_sf =  1.0 #0.85 #0.85 #0.85 # 1.0 #0.85 #1.0 #0.85 #0.85#0.85 #0.85 #0.87  #0.9 #1.0 #0.94 #0.97 #0.97# 1.#0.64 #0.87 #0.88#0.905#0.93 #0.91 #0.97 #0.98 #0.98
z_sf = 1.0 #1.35 #1.35 #1.35 # 1.00 #1.0# 1.35 #1.35 #1.31#1.30#27#2 #1.3

#ggf = sample.Sample("ggFHiggs", "ggF")
#ggf.scalefactor = lumi_factor
#ggf.color = 'k'
#ggf.load(filelist_dir + "ggf_higgs_mc16a", h5_dir_mc, tags = tags)
#loaded_samples.append(ggf)
#
#zh = sample.Sample("ZH", "ZH")
#zh.scalefactor = lumi_factor
#zh.color = 'g'
#zh.load(filelist_dir + "zh_mc16a", h5_dir_mc, tags = tags)
...
zjets = sample.Sample("ZjetsDYFull", "$Z/\\gamma*$+jets")# $\\times %s$" % z_sf)
zjets.scalefactor = lumi_factor * z_sf
zjets.fillstyle = 0
zjets.linestyle = '-'
zjets.color = "#fc8f1e"
zjets.load(filelist_dir + "zjets_and_dy_sherpa_mc16a", h5_dir_mc, tags = tags) #['mc16a', 'mc16d', 'mc16e'])
loaded_samples.append(zjets)
...
dy = sample.Sample("DYFull", "DY $\\times %.2f$" % (float(z_sf)))
...
r.tcut = "nBJets>=2 && mll>20 && mll<60 && mbb>110 && mbb<140"
loaded_regions.append(r)
...
r = region.Region("preselNoMBB", "Pre-selection")
r.tcut = "nBJets>=2 && mll>20"
loaded_regions.append(r)

r = region.Region("srpre", "SR (no $d_{hh}$ cut)")
r.tcut = "nBJets>=2 && mll>20 && mll<60"
loaded_regions.append(r)
...
variables["met"]                    = { "presel": [60, 0, 600], "crtoptest" : [100, 0, 600]    ,    "vrtoptest" : [50, 0, 400]    ,    "crztest" :  [20, 0, 200],    "vrztest" :  [20, 0, 240]}
variables["mbb"]                    = { "presel": [2, 100, 140], "crtoptest" : [100, 0, 800],       "vrtoptest" : [100, 100, 800],       "crztest" :  [10, 100, 160],  "vrztest" :  [5, 100, 140]}
variables["abs(metPhi)"]            = { "presel": [0.16, 0, 3.2], "crtoptest" : [0.64, 0, 3.2] ,   "vrtoptest" : [0.64, 0, 3.2] ,   "crztest" : [0.64, 0, 3.2],   "vrztest" : [0.64, 0, 3.2]}
variables["mll"]                    = { "presel": [60, 0, 1200], "crtoptest" : [5, 20, 60]    ,     "vrtoptest" : [5, 20, 60]    ,     "crztest" : [1, 80, 102],     "vrztest" : [5, 70, 115]}
variables["dRll"]                   = { "presel": [0.3, 0, 6], "crtoptest" : [0.22, 0, 2.2]      ,  "vrtoptest" : [0.18, 0, 1.8]      ,  "crztest" : [0.25, 0, 2.5],      "vrztest" : [0.5, 0, 2.5]}
variables["pTll"]                   = { "presel": [60, 0, 600], "crtoptest" : [50, 0, 450]    ,    "vrtoptest" : [50, 0, 600]    ,    "crztest" :  [50, 0, 600],   "vrztest" :  [50, 0, 500]}
variables["abs(dphi_ll)"]           = { "presel": [0.64, 0, 3.2], "crtoptest" : [0.2, 0, 1.6] ,   "vrtoptest" : [0.16, 0, 1.6] ,   "crztest" : [0.32, 0, 2.56],   "vrztest" : [0.3, 0, 3]} 
variables["abs(dphi_bb)"]           = { "presel": [0.64, 0, 3.2], "crtoptest" : [0.64, 0, 3.2] ,   "vrtoptest" : [0.64, 0, 3.2] ,   "crztest" : [0.32, 0, 3.2],   "vrztest" : [0.32, 0, 3.2]}
variables["abs(dphi_met_ll)"]       = { "presel": [0.64, 0, 3.2], "crtoptest" : [0.64, 0, 3.2] ,   "vrtoptest" : [0.64, 0, 3.2] ,   "crztest" : [0.64, 0, 3.2],   "vrztest" : [0.64, 0, 3.2]}
variables["met_pTll"]               = { "presel": [80, 0, 800], "crtoptest" : [100, 0, 700]    ,    "vrtoptest" : [100, 0, 600]    ,    "crztest" :  [50, 0, 600],    "vrztest" :  [50, 50, 500]}
...
variables["HT2"]                    = { "presel": [100, 0, 2000], "crtoptest" : [100, 300, 1300]    ,    "vrtoptest" : [200, 100, 1300]    ,    "crztest" : [100, 100, 800],    "vrztest" : [80, 100, 800]}
variables["HT2Ratio"]               = { "presel": [0.05, 0, 1], "crtoptest" : [0.1, 0.2, 1]  ,    "vrtoptest" : [0.1, 0.2, 1]  ,    "crztest" : [0.1, 0.4, 1],   "vrztest" : [0.05, 0.6, 1]}
variables["l0_pt"]                  = { "presel": [60, 0, 600], "crtoptest" : [30, 20, 300]    ,    "vrtoptest" : [50, 0, 400]    ,    "crztest" :  [20, 0, 400],   "vrztest" :  [30, 30, 330]} 
variables["l1_pt"]                  = { "presel": [15, 0, 330], "crtoptest" : [20, 10, 120]     ,    "vrtoptest" : [25, 0, 150]     ,    "crztest" : [20, 0, 200],     "vrztest" : [15, 0, 150]}
variables["abs(l0_phi)"]            = { "presel": [0.64, 0, 3.2], "crtoptest" : [0.64, 0, 3.2] ,   "vrtoptest" : [0.64, 0, 3.2] ,   "crztest" : [0.64, 0, 3.2],   "vrztest" : [0.64, 0, 3.2]}
variables["abs(l1_phi)"]            = { "presel": [0.64, 0, 3.2], "crtoptest" : [0.64, 0, 3.2] ,   "vrtoptest" : [0.64, 0, 3.2] ,   "crztest" : [0.64, 0, 3.2],   "vrztest" : [0.64, 0, 3.2]}
variables["j0_pt"]                  = { "presel": [120, 0, 1200], "crtoptest" : [100, 0, 800]    ,    "vrtoptest" : [80, 80, 800]    ,    "crztest" : [45, 0, 500],    "vrztest" : [60, 0, 600]}
variables["j1_pt"]                  = { "presel": [80, 0, 800], "crtoptest" : [50, 0, 500]     ,   "vrtoptest" : [50, 0, 500]     ,   "crztest" : [30, 0, 320],     "vrztest" : [30, 0, 300]} 
variables["abs(j0_phi)"]            = { "presel": [0.64, 0, 3.2], "crtoptest" : [0.64, 0, 3.2] ,   "vrtoptest" : [0.64, 0, 3.2] ,   "crztest" : [0.64, 0, 3.2],   "vrztest" : [0.64, 0, 3.2]}
variables["abs(j1_phi)"]            = { "presel": [0.64, 0, 3.2], "crtoptest" : [0.64, 0, 3.2] ,   "vrtoptest" : [0.64, 0, 3.2] ,   "crztest" : [0.64, 0, 3.2],   "vrztest" : [0.64, 0, 3.2]}
variables["bj0_pt"]                 = { "presel": [60, 0, 600], "crtoptest" : [100, 0, 800]    ,   "vrtoptest" : [100, 0, 800]    ,   "crztest" :  [30, 0, 500],   "vrztest" :  [40, 0, 400]}
variables["bj1_pt"]                 = { "presel": [20, 0, 200], "crtoptest" : [30, 0, 300]     ,   "vrtoptest" : [50, 0, 400]     ,   "crztest" : [20, 20, 200],     "vrztest" : [20, 20, 150]}
variables["abs(bj0_phi)"]           = { "presel": [0.64, 0, 3.2], "crtoptest" : [0.64, 0, 3.2] ,   "vrtoptest" : [0.64, 0, 3.2] ,   "crztest" : [0.64, 0, 3.2],   "vrztest" : [0.64, 0, 3.2]}
variables["abs(bj1_phi)"]           = { "presel": [0.64, 0, 3.2], "crtoptest" : [0.64, 0, 3.2] ,   "vrtoptest" : [0.64, 0, 3.2] ,   "crztest" : [0.64, 0, 3.2],   "vrztest" : [0.64, 0, 3.2]}
variables["mt2_bb"]                 = { "presel": [40, 0, 400], "crtoptest" : [40, 0, 320],        "vrtoptest" : [30, 0, 300],        "crztest" : [40, 0, 280],     "vrztest" : [15, 0, 180]}
#variables["NN_d_hh"]                = { "presel": [2, -20, 20], "crtoptest" : [0.5, -7, 1],        "vrtoptest" : [0.5, -7, 1],        "crztest" : [0.5, -7, 1],       "vrztest" : [0.5, -7, 1]}  
variables["NN_d_hh"]                = { "presel": [2, -20, 20], "crtoptest" : [1.0, -10, 10],        "vrtoptest" : [1, -10, 12],        "crztest" : [1, -10, 10],       "vrztest" : [1, -10, 8]}  
#variables["NN_d_top"]                = { "presel": [2, -20, 20], "crtoptest" : [1.0, -12, 12],        "vrtoptest" : [1, -10, 12],        "crztest" : [2, -14, 14],       "vrztest" : [1, -10, 8]}  
#variables["NN_d_zsf"]                = { "presel": [2, -20, 20], "crtoptest" : [2.0, -46, -4],        "vrtoptest" : [1, -10, 12],        "crztest" : [4, -40, 4],       "vrztest" : [1, -10, 8]}  
#variables["NN_d_ztt"]                = { "presel": [2, -20, 20], "crtoptest" : [1.0, -18, 5],        "vrtoptest" : [1, -10, 12],        "crztest" : [1, -16, 2],       "vrztest" : [1, -10, 8]}  
#variables["NN_d_hh"]                = { "presel": [2, -20, 20], "crtoptest" : [1.0, 4.5, 10],        "vrtoptest" : [1, 4.5, 10],        "crztest" : [1, 0, 10],       "vrztest" : [1, 0, 6]}  
variables["dRbb"]                   = { "presel": [0.25, 0, 5], "crtoptest" : [0.4, 0.4, 4.0],         "vrtoptest" : [0.55, 0.4, 4.8],         "crztest" : [0.5, 0, 3.5],      "vrztest" : [0.5, 0, 3]}   
variables["abs(deta_ll)"]           = { "presel": [0.2, 0, 4], "crtoptest" : [0.2, 0, 1.6],        "vrtoptest" : [0.2, 0, 1.2],        "crztest" : [0.2, 0, 2],      "vrztest" : [0.2, 0, 2.4]}   
variables["abs(dphi_WW_bb)"]        = { "presel": [0.64, 0, 3.2], "crtoptest" : [0.64, 0, 3.2],       "vrtoptest" : [0.4, 0, 3.2],       "crztest" : [0.64, 0, 3.2],   "vrztest" : [0.64, 0, 3.2]}

tmp = {}
#tmp["NN_d_hh"]  = { "srpre" : [1, -50, 50] }
#tmp["NN_d_hh"]  = { "srpre" : [1, -12, 12] }
#tmp["NN_d_hh"]  = { "srpre" : [1, 0, 12] }
tmp["NN_d_hh"]  = { "srpre" : [0.5, 4, 9] }
#tmp["NN_d_top"] = { "srpre" : [2, -20, 12] }
#tmp["NN_d_zsf"] = { "srpre" : [4, -60, 4] }
#tmp["NN_d_ztt"] = { "srpre" : [2, -20, 4] }
variables = tmp
...
nice_names["NN_d_zsf"]   = ["$d_{Z-SF}$"]
nice_names["NN_d_ztt"]   = ["$d_{Z-\\tau\\tau}$"]
nice_names["NN_d_top"]   = ["$d_{top}$"]
