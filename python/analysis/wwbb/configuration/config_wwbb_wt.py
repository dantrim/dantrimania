...
r.tcut = "%s && (l_flav==2 || l_flav==3) && nBJets==1 && nBLSJets==2 && nSJets==1 && mll>20 && l0_pt>35 && l1_pt>20 && HT2Ratio_bls>0.8 && dRll<0.9" % ( trigger )#,)isSF, isDF) #, trigger)
...
r.tcut = "%s && nBJets==1 && nBLMJets==2 && nSJets>=1 && mll>20 && l0_pt>25 && l1_pt>20 && HT2Ratio_blm>0.8 && dRll<0.9" % ( trigger )#,)isSF, isDF) #, trigger)
...
#############################################################
variables = {}
#variables["HT2Ratio"] = { "wwbbpre_wtblm" : [0.005, 0.98, 1.0] } # if a 4th argument is given, override automatic setting of y-max
#variables["HT2Ratio"] =     { "wwbbpre_wtblm" : [0.05, 0.0, 1.0] , "vrht2ratio" : [0.03, 0.2, 0.8] , "vrtt0" : [0.05, 0.0, 1.0] }
#variables["HT2Ratio_blm"] =     { "wwbbpre_wtblm" : [0.02, 0.2, 0.4] , "vrht2ratio" : [0.01, 0.8, 1.0] , "vrtt0" : [0.05, 0.0, 1.0] }
variables["HT2Ratio_blm"] =     { "wwbbpre_wtblm" : [0.05, 0.0, 1.0] , "vrht2ratio" : [0.01, 0.8, 1.0] , "vrtt0" : [0.05, 0.0, 1.0] }
variables["nBJets"] =           { "wwbbpre_wtblm" : [1, 0, 6]       , "vrht2ratio" : [1, 0, 6]       , "vrtt0" : [1, 0, 5] }
variables["dRll"] =             { "wwbbpre_wtblm" : [0.4, 0, 5]      , "vrht2ratio" : [0.05, 0.9, 2.0]    , "vrtt0" : [0.03, 0, 0.9] }
#variables["dRll"] =            { "wwbbpre_wtblm" : [0.1, 0, 5]      , "vrht2ratio" : [0.05, 0.0, 0.9]    , "vrtt0" : [0.03, 0, 0.9] }
variables["MT_1_scaled_blm"] =  { "wwbbpre_wtblm" : [40, 0, 1500]    , "vrht2ratio" : [40, 0, 1500]    , "vrtt0" : [40, 0, 1500] }
variables["mt2_llbb_blm"] =     { "wwbbpre_wtblm" : [10, 60, 400]    , "vrht2ratio" : [2, 90, 140]     , "vrtt0" : [2, 90, 140] }
variables["dRbb_blm"] =         { "wwbbpre_wtblm" : [0.1, 0, 6]      , "vrht2ratio" : [0.1, 0, 6]      , "vrtt0" : [0.1, 0, 6] }
variables["l0_pt"] =            { "wwbbpre_wtblm" : [10, 0, 300]     , "vrht2ratio" : [10, 0, 300]     , "vrtt0" : [10, 0, 300] }
variables["l1_pt"] =            { "wwbbpre_wtblm" : [10, 0, 200]     , "vrht2ratio" : [10, 0, 200]     , "vrtt0" : [10, 0, 200] }
variables["mbb_blm"] =          { "wwbbpre_wtblm" : [10, 0, 600]     , "vrht2ratio" : [2, 100,140]     , "vrtt0" : [2, 100, 140] }
variables["mt2_bb_blm"] =       { "wwbbpre_wtblm" : [10, 0, 250] }
variables["nBLSJets"] =         { "wwbbpre_wtblm" : [1, 0, 6] }
variables["nBLMJets"] =         { "wwbbpre_wtblm" : [1, 0, 6] }
variables["mll"] =              { "wwbbpre_wtblm" : [10, 20, 500] }
variables["abs(dphi_ll)"] =     { "wwbbpre_wtblm" : [0.02, 0, 0.5] }
#variables["abs(dphi_ll)"] =     { "wwbbpre_wtblm" : [0.1, 0, 3.2] }
variables["abs(dphi_met_ll)"] = { "wwbbpre_wtblm" : [0.1, 0, 3.2] }
variables["abs(dphi_bj0_ll)"] = { "wwbbpre_wtblm" : [0.1, 0, 3.2] }
variables["abs(dphi_bj0_l0)"] = { "wwbbpre_wtblm" : [0.1, 0, 3.2] }
variables["met"] =              { "wwbbpre_wtblm" : [10, 0, 400] }
...
nice_names["mt2_bb_blm"] = ["$m_{T2}^{bb}", "GeV"]
nice_names["HT2Ratio_blm"] = ["$H_{T2}^{R}$"]
nice_names["nBJets"] = ["# $b-$jets"]
nice_names["dRll"] = ["$\\Delta R_{\\ell \\ell}$"]
nice_names["MT_1_scaled_blm"] = ["M$_{T1}$", "GeV"]
