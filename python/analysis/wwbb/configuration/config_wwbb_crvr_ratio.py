...
#wt = sample.Sample("WtAMC", "$Wt$ (aMC@NLO)")
...
## CR ttbar
r = region.Region("crtt", "CR-$t\\bar{t}$ (Top)")
r.tcut = "%s && nBJets==2 && mll>20  && mbb>100 && mbb<140 && mt2_llbb>90 && mt2_llbb<140 && dRll>1.5 && dRll<3.0 && HT2Ratio>0.4 && HT2Ratio<0.6" % ( trigger )
...
#r.tcut = "%s && nBJets==2 && mll>20 && mbb>140 && dRll>1.2 && mt2_bb>150" % (trigger)
##VRr.tcut = "%s && nBJets==2 && mll>20 && mbb>140 && dRll<1.2 && mt2_bb>150" % (trigger)

#r.tcut = "%s && nBJets==2 && mll>20 && mbb>100 && mbb<140 && HT2Ratio>0.8 && mt2_bb>150" % (trigger)
#r.tcut = "%s && nBJets==2 && mll>20 && mbb>140 && dRll<0.9 && HT2Ratio>0.8 && mt2_bb>150" % (trigger)
##CRr.tcut = "%s && nBJets==2 && mll>20 && mbb>140 && dRll>1.2 && HT2Ratio>0.8 && mt2_bb>150" % (trigger)
#r.tcut = "%s && nBJets==2 && mll>20 && mbb<140 && mbb>100 && dRll>0.9 && HT2Ratio>0.8 && mt2_bb>150" % (trigger)
#r.tcut = "%s && nBJets==2 && mll>20 && mbb>140 && dRll>2.0 && HT2Ratio>0.8 && mt2_bb>150" % (trigger)
#r.tcut = "%s && nBJets==2 && mll>20 && mbb>140 && dRll<2.0 && HT2Ratio>0.8 && mt2_bb>150" % (trigger)
...
#r.tcut = "%s && nBJets==2 && mll>20 && mbb>140 && HT2Ratio>0.7 && dRll>1.2 && mt2_bb>145" % ( trigger )
#r.tcut = "%s && nBJets==2 && mll>20 && dRll>0.9 && mbb>140 && mt2_bb>150" % ( trigger )
#r.tcut = "%s && nBJets==2 && mll>20 && HT2Ratio<0.8 && HT2Ratio>0.4 && mbb>140 && mt2_bb>150" % ( trigger )
#r.tcut = "%s && nBJets==2 && mll>20 && HT2Ratio<0.8 && HT2Ratio>0.4 && mbb>140 && mt2_bb>150" % ( trigger )
#r.tcut = "%s && nBJets==2 && mll>20 && HT2Ratio>0.8 && mt2_bb>150 && dRll>0.9" % ( trigger )
#r.tcut = "%s && nBJets==2 && mll>20 && mbb>140 && (mt2_llbb<90 || mt2_llbb>140) && HT2Ratio>0.7 && mt2_bb>150 && dRll>0.9" % ( trigger )
#r.tcut = "%s && nBJets==2 && mll>20 && l0_pt>25 && l1_pt>20 && mbb>140 && (mt2_llbb<90 || mt2_llbb>140) && HT2Ratio>0.7 && mt2_bb>150 && dRll>1.2" % ( trigger )
#r.tcut = "%s && nBJets==2 && mll>20 && l0_pt>25 && l1_pt>20 && (mbb<100 || mbb>140) && (mt2_llbb<90 || mt2_llbb>140) && HT2Ratio>0.5 && mt2_bb>150" % ( trigger )
loaded_regions.append(r)
...
#r.tcut = "%s && nBJets==2 && (mll < 71 || mll > 111) &&  l0_pt>25 && l1_pt>20 &&  HT2Ratio>0.8 && dRll<0.9" % ( trigger)
r.tcut = "%s && nBJets==2 && (mbb>100 && mbb<140) && (mt2_llbb>90 && mt2_llbb<140) && HT2Ratio>0.8 && dRll<0.9 && mt2_bb>130" % ( trigger )
#r.tcut = "%s && nBJets==2 && (mbb>100 && mbb<140) && (mt2_llbb>90 && mt2_llbb<140) && HT2Ratio>0.8 && dRll<0.9 && mt2_bb>120" % ( trigger )
#r.tcut = "%s && nBJets==2 && (mll<71 || mll>111) && l0_pt>25 && l1_pt>20 && (mbb>100 && mbb<140) && (mt2_llbb>90 && mt2_llbb<140) && HT2Ratio>0.8 && dRll<0.9 && mt2_bb>130" % ( trigger )
loaded_regions.append(r)
...
region_to_use = "crtt"
variables["HT2Ratio"] =     { region_to_use : [0.1, 0.0, 1.0]}# , "vrht2ratio" : [0.01, 0.8, 1.0] , "vrtt0" : [0.05, 0.0, 1.0] }
variables["nBJets"] =       { region_to_use : [1, 0, 6]       }#, "vrht2ratio" : [1, 0, 6]       , "vrtt0" : [1, 0, 5] }
variables["dRll"] =         { region_to_use : [0.5, 0, 5]     }# , "vrht2ratio" : [0.05, 0.9, 2.0]    , "vrtt0" : [0.03, 0, 0.9] }
variables["MT_1_scaled"] =  { region_to_use : [200, 0, 1600]   }# , "vrht2ratio" : [40, 0, 1500]    , "vrtt0" : [40, 0, 1500] }
variables["mt2_llbb"] =     { region_to_use : [20, 60, 400]   }# , "vrht2ratio" : [2, 90, 140]     , "vrtt0" : [2, 90, 140] }
variables["dRbb"] =         { region_to_use : [0.5, 0, 6]     }# , "vrht2ratio" : [0.1, 0, 6]      , "vrtt0" : [0.1, 0, 6] }
variables["l0_pt"] =        { region_to_use : [20, 0, 300]    }# , "vrht2ratio" : [10, 0, 300]     , "vrtt0" : [10, 0, 300] }
variables["l1_pt"] =        { region_to_use : [20, 0, 200]    }# , "vrht2ratio" : [10, 0, 200]     , "vrtt0" : [10, 0, 200] }
variables["mbb"] =          { region_to_use : [40, 0, 600]    }# , "vrht2ratio" : [2, 100,140]     , "vrtt0" : [2, 100, 140] }
variables["bj0_pt"] =       { region_to_use : [50, 0, 400] }
variables["bj1_pt"] =       { region_to_use : [50, 0, 400] }
variables["mt2_bb"] =       { region_to_use : [20, 0, 400] }
