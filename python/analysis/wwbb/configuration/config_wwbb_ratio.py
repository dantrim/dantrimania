...
h5_dir_mc_wt = "/data/uclhc/uci/user/dantrim/ntuples/n0306/b_dec12/mc/mc16a/h5/"
...
ttbar = sample.Sample("ttbarEJan15", "$t\\bar{t}$") # \\times 0.95$")
...
ttbar.color = "#0057FF"
#ttbar.color = "#3f88c5"
ttbar.load(filelist_dir + "ttbar_mc16a", h5_dir_mc_top, tags = ["mc16e"])#, "mc16d", "mc16e"] ) #tags)
#ttbar.load(filelist_dir + "ttbar_mc16a", h5_dir_mc, tags = ["mc16a", "mc16d"]) #, "mc16e"] ) #tags)
loaded_samples.append(ttbar)

wt = sample.Sample("WtDREJan15", "$Wt$ (DR)") #  \\times 0.35$")
...
wt.color = "#008AFF"
#wt.color = "#e94f37"
wt.load(filelist_dir + "WtPP8_mc16a", h5_dir_mc_top, tags = ['mc16e'])#, 'mc16d', 'mc16e'])
...
# nn input features
variables["met"]            = { "nn_preMBB2" : [30, 0, 600]    , "nn_pre" : [50, 0, 1000]    , "crtop" : [30, 0, 600]    , "nn_crwt" : [30, 0, 600]     ,"nn_crz" : [20, 0, 400]    }
variables["mbb"]            = { "nn_preMBB2" : [120, 0, 2400],  "crtop" : [45, 100, 1000], "nn_crwt" : [60, 140, 1200] }
variables["metPhi"]         = { "nn_preMBB2" : [0.4, -3.2, 3.2] , "nn_pre" : [0.4, -3.2, 3.2] ,  "crtop" : [0.4, -3.2, 3.2], "nn_crwt" : [0.4, -3.2, 3.2] ,"nn_crz" : [0.2, -3.2, 3.2]}
variables["mll"]            = { "nn_preMBB2" : [60, 0, 1200]    , "nn_pre" : [60, 0, 1200]    , "crtop" : [8, 0, 160]    , "nn_crwt" : [40, 0, 800]     ,"nn_crz" : [20, 0, 600]    }
variables["dRll"]           = { "nn_preMBB2" : [0.3, 0, 6]      , "nn_pre" : [0.3, 0, 6]      ,  "crtop" : [0.15, 0, 3]     , "nn_crwt" : [0.2, 0, 5]      ,"nn_crz" : [0.2, 0, 5]     }
variables["pTll"]           = { "nn_preMBB2" : [30, 0, 600]    , "nn_pre" : [50, 0, 1000]    , "crtop" : [20, 0, 400]    , "nn_crwt" : [30, 0, 600]     ,"nn_crz" : [20, 0, 400]    }
variables["dphi_ll"]        = { "nn_preMBB2" : [0.4, -3.2, 3.2] , "nn_pre" : [0.4, -3.2, 3.2] , "crtop" : [0.4, -3.2, 3.2], "nn_crwt" : [0.4, -3.2, 3.2] ,"nn_crz" : [0.2, -3.2, 3.2]}
variables["dphi_bb"]        = { "nn_preMBB2" : [0.4, -3.2, 3.2] , "nn_pre" : [0.4, -3.2, 3.2] , "crtop" : [0.4, -3.2, 3.2], "nn_crwt" : [0.4, -3.2, 3.2] ,"nn_crz" : [0.2, -3.2, 3.2]}
variables["dphi_met_ll"]    = { "nn_preMBB2" : [0.4, -3.2, 3.2] , "nn_pre" : [0.4, -3.2, 3.2] , "crtop" : [0.4, -3.2, 3.2], "nn_crwt" : [0.4, -3.2, 3.2] ,"nn_crz" : [0.2, -3.2, 3.2]}
variables["met_pTll"]       = { "nn_preMBB2" : [40, 0, 800]    , "nn_pre" : [60, 0, 1200]    , "crtop" : [40, 0, 800]    , "nn_crwt" : [50, 0, 1000]     ,"nn_crz" : [20, 0, 600]    }
variables["nJets"]          = { "nn_preMBB2" : [1, 0, 20]       , "nn_pre" : [1, 0, 20]       , "crtop" : [1, 0, 20]      , "nn_crwt" : [1, 0, 12]       ,"nn_crz" : [1, 0, 12]      }      
variables["nSJets"]         = { "nn_preMBB2" : [1, 0, 20]       , "nn_pre" : [1, 0, 20]       , "crtop" : [1, 0, 10]      , "nn_crwt" : [1, 0, 12]       ,"nn_crz" : [1, 0, 12]      }
variables["nBJets"]         = { "nn_preMBB2" : [1, 0, 10]       , "nn_pre" : [1, 0, 10]       , "crtop" : [1, 0, 10]       , "nn_crwt" : [1, 0, 6]        ,"nn_crz" : [1, 0, 6]       }
variables["HT2"]            = { "nn_preMBB2" : [60, 0, 1500]    , "nn_pre" : [60, 0, 1500]    , "crtop" : [100, 0, 2000]    , "nn_crwt" : [75, 0, 1500]     ,"nn_crz" : [30, 0, 900]    }
variables["HT2Ratio"]       = { "nn_preMBB2" : [0.05, 0, 1]     , "nn_pre" : [0.05, 0, 1]     , "crtop" : [0.025, 0.5, 1]    , "nn_crwt" : [0.05, 0, 1]     ,"nn_crz" : [0.05, 0, 1]    }
variables["l0_pt"]          = { "nn_preMBB2" : [30, 0, 600]    , "nn_pre" : [50, 0, 1000]    , "crtop" : [20, 0, 400]    , "nn_crwt" : [30, 0, 600]     ,"nn_crz" : [10, 0, 350]    }
variables["l1_pt"]          = { "nn_preMBB2" : [15, 0, 330]     , "nn_pre" : [30, 0, 600]     , "crtop" : [10, 0, 200]    , "nn_crwt" : [10, 0, 250]     ,"nn_crz" : [10, 0, 250]    }
variables["l0_phi"]         = { "nn_preMBB2" : [0.4, -3.2, 3.2] , "nn_pre" : [0.4, -3.2, 3.2] , "crtop" : [0.4, -3.2, 3.2], "nn_crwt" : [0.4, -3.2, 3.2] ,"nn_crz" : [0.2, -3.2, 3.2]}
variables["l1_phi"]         = { "nn_preMBB2" : [0.4, -3.2, 3.2] , "nn_pre" : [0.4, -3.2, 3.2] , "crtop" : [0.4, -3.2, 3.2], "nn_crwt" : [0.4, -3.2, 3.2] ,"nn_crz" : [0.2, -3.2, 3.2]}
variables["j0_pt"]          = { "nn_preMBB2" : [60, 0, 1200]    , "nn_pre" : [60, 0, 1200]    , "crtop" : [40, 0, 800]    , "nn_crwt" : [50, 0, 1000]     ,"nn_crz" : [20, 0, 500]    }
variables["j1_pt"]          = { "nn_preMBB2" : [40, 0, 800]     , "nn_pre" : [40, 0, 800]     , "crtop" : [60, 0, 600]    , "nn_crwt" : [30, 0, 600]     ,"nn_crz" : [10, 0, 250]    }
variables["j0_phi"]         = { "nn_preMBB2" : [0.4, -3.2, 3.2] , "nn_pre" : [0.4, -3.2, 3.2] , "crtop" : [0.4, -3.2, 3.2], "nn_crwt" : [0.4, -3.2, 3.2] ,"nn_crz" : [0.2, -3.2, 3.2]}
variables["j1_phi"]         = { "nn_preMBB2" : [0.4, -3.2, 3.2] , "nn_pre" : [0.4, -3.2, 3.2] , "crtop" : [0.4, -3.2, 3.2], "nn_crwt" : [0.4, -3.2, 3.2] ,"nn_crz" : [0.2, -3.2, 3.2]}
variables["bj0_pt"]         = { "nn_preMBB2" : [30, 0, 600]    , "nn_pre" : [60, 0, 1200]    , "crtop" : [30, 0, 600]    , "nn_crwt" : [50, 0, 1000]     ,"nn_crz" : [20, 0, 400]    }
variables["bj1_pt"]         = { "nn_preMBB2" : [10, 0, 200]     , "nn_pre" : [40, 0, 800]     , "crtop" : [20, 0, 400]    , "nn_crwt" : [20, 0, 400]     ,"nn_crz" : [10, 0, 200]    }
variables["bj0_phi"]        = { "nn_preMBB2" : [0.4, -3.2, 3.2] , "nn_pre" : [0.4, -3.2, 3.2] , "crtop" : [0.4, -3.2, 3.2], "nn_crwt" : [0.4, -3.2, 3.2] ,"nn_crz" : [0.2, -3.2, 3.2]}
variables["bj1_phi"]        = { "nn_preMBB2" : [0.4, -3.2, 3.2] , "nn_pre" : [0.4, -3.2, 3.2] , "crtop" : [0.4, -3.2, 3.2], "nn_crwt" : [0.4, -3.2, 3.2] ,"nn_crz" : [0.2, -3.2, 3.2]}
variables["mt2_bb"]         = { "crtop" : [15, 0, 300], "nn_crwt" : [10, 0, 300],  "nn_pre" : [10, 0, 450], "nn_preMBB2" : [20, 0, 340] }
#variables["NN_p_hh"]        = { "nn_pre" : [0.05, 0, 1], "crtop" : [0.05, 0, 1], "nn_crwt" : [0.005, 0, 0.1], "nn_crz" : [0.05, 0, 1]}
#variables["NN_p_tt"]        = { "nn_pre" : [0.05, 0, 1], "crtop" : [0.05, 0, 1], "nn_crwt" : [0.005, 0, 0.1], "nn_crz" : [0.05, 0, 1]}
#variables["NN_p_wt"]        = { "nn_pre" : [0.05, 0, 1], "crtop" : [0.05, 0, 1], "nn_crwt" : [0.005, 0.9, 1], "nn_crz" : [0.05, 0, 1]}
#variables["NN_p_zjets"]     = { "nn_pre" : [0.05, 0, 1], "crtop" : [0.05, 0, 1], "nn_crwt" : [0.001, 0, 0.05], "nn_crz" : [0.05, 0, 1]}
variables["NN_d_hh"]        = { "nn_preMBB2" : [2, -40, 12], "crtop" : [1, 0, 20], "nn_crwt" : [2, -50, 0], "nn_crz" : [2, -20, 30]}
variables["NN_d_tt"]        = { "nn_preMBB2" : [2, -15, 6], "crtop" : [2, -20, 4] , "nn_crwt" : [0.5, -12, 0] , "nn_crz" : [1, -15, 5] }
#variables["NN_d_wt"]        = { "nn_pre" : [2, -25, 20], "crtop" : [0.25, -5, 0], "nn_crwt" : [0.5, 0, 10], "nn_crz" : [2, -40, 10]}
#variables["NN_d_zjets"]     = { "nn_pre" : [2, -30, 10], "crtop" : [2, -30, 0], "nn_crwt" : [2, -50, -8], "nn_crz" : [1, -15, 10]}
#variables["MT_1_scaled"] = { "crtop" : [40, 160, 1000] }

tmp = {}
tmp["l0_pt"] = { "wwbbpre" : [10, 0, 500] }
variables = tmp
